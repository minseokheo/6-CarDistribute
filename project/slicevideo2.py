...
vfilepath='C:/Users/HOME/Desktop/project/video/trackingvideo/resultvid.avi' #이미지로 자를 영상 경로
...
while(True):
    ...
    if(int(videofile.get(1))): # 몇 프레임 당 1장씩 자를지
        cv2.imwrite('C:/Users/HOME/Desktop/project/video/crop_video2/%d.jpg'%count,image) # 동영상 저장경로
