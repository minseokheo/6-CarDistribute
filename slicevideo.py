...
for i in range(5,6):
    vfilepath='C:/Users/HOME/Desktop/code/code/video/'+str(i)+'.avi' #이미지로 자를 영상 경로
    ...
    while(True):
        ...
        if(int(videofile.get(1))): # 몇 프레임 당 1장씩 자를지
            cv2.imwrite('C:/Users/HOME/Desktop/code/code/myimg/'+str(i)+'/%d.jpg'%count,image) # 동영상 저장경로
